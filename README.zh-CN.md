...
**全能开发工具箱 —— 8 大分类、117 个实用工具，桌面 + Web 双端。**
...
### 🛠️ 格式化 *(9)*
Markdown 编辑器 · Mermaid 编辑器(实时预览, 导出 SVG/PNG/WebP) · JSON 格式化 · JSON5 格式化 · SQL 格式化 · XML 格式化 · HTML 格式化 · SVG 格式化 · 中英文自动排版
...
│   │       ├── lib.test.ts   # jest 单测 (89 个工具)
│   │       ├── data.ts       # 选项/常量表与类型 (53 个工具)
│   │       ├── setting.tsx   # 设置中心内本工具的设置面板 (63 个工具)
│   │       └── intro.tsx     # About/说明 三语内容 (40 个工具)
│   ├── layout/           # 主框架: 侧边栏/内容区
│   ├── hook/             # 全局状态: 主题/应用上下文
│   └── lib/              # 通用工具库
