...
<li><p>点击「保存全部到文件夹」: 桌面版弹出目录选择框, 一次写入全部小图; 也可以点每张小图右下角的「保存」单独导出</p></li>
</ul>
...
<li><p>點擊「儲存全部到資料夾」: 桌面版會彈出目錄選擇框, 一次寫入全部小圖; 也可點每張小圖右下角的「儲存」單獨匯出</p></li>
</ul>
...
<li><p>Click "Save all to folder": the desktop build opens a folder picker and writes every tile at once. You can also save a single tile with the button on each thumbnail</p></li>
</ul>
