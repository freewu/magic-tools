...
<blockquote><p>把讲稿粘贴进来, 让文字按设定速度自动向上滚动 —— 直播、录课、发布会、口播视频对着念就行。全部在本地完成 (不联网、不上传), 支持<strong>速度调节</strong>、<strong>上下边缘淡入淡出</strong>、<strong>全屏播放</strong>与<strong>空格暂停/开始</strong>。</p></blockquote>
...
<li><p>「淡入淡出」让文字在上下边缘渐隐, 视线更容易锁定中间那几行; 关闭后文字会硬生生地出现与消失</p></li>
...
<blockquote><p>把講稿貼進來, 讓文字按設定速度自動向上捲動 —— 直播、錄課、發表會、口播影片對著念就行。全部在本機完成 (不連網、不上傳), 支援<strong>速度調節</strong>、<strong>上下邊緣淡入淡出</strong>、<strong>全螢幕播放</strong>與<strong>空格暫停/開始</strong>。</p></blockquote>
...
<li><p>「淡入淡出」讓文字在上下邊緣漸隱, 視線更容易鎖定中間那幾行; 關閉後文字會硬生生地出現與消失</p></li>
...
<blockquote><p>Paste your script and let it scroll upwards at the speed you choose — handy for live streams, recorded lessons, launches and talking-head videos. Everything runs locally (offline, nothing uploaded) with <strong>speed control</strong>, <strong>fade-in / fade-out edges</strong>, <strong>fullscreen playback</strong> and <strong>space to pause / resume</strong>.</p></blockquote>
...
<li><p>“Fade edges” dissolves lines in at the bottom and out at the top, which keeps your eyes on the middle rows; turn it off and text appears and disappears abruptly</p></li>
