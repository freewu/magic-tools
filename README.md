...
**An all-in-one developer toolbox — 131 utilities in 9 categories, cross-platform desktop & Web.**
...
│   │   └── <Tool>/           # one folder per tool (131, grouped list below) — 2-step registration
